...
//       <div style={sidebarStyles.logoArea}>
//         <div style={sidebarStyles.logoCircle}>🚌</div>
//         <h2 style={sidebarStyles.brandName}> Admin</h2>
//       </div>
...
// const sidebarStyles = {
//   wrapper: { width: "210px", height: "100vh", backgroundColor: "#0D1117", borderRight: "1px solid #2D3748", display: "flex", flexDirection: "column", position: "fixed", left: 0, top: 0 },
...
export default function Sidebar({ active, isOpen, setIsOpen }) {
  ...
  return (
    <div style={{
      ...
      width: "210px" // Fixed width for the inner content
    }}>
      <div style={sidebarStyles.logoArea}>
        <div style={sidebarStyles.logoCircle}>🚌</div>
        <h2 style={sidebarStyles.brandName}>Admin</h2>
      ...
      <div style={sidebarStyles.footer}>
        <button style={sidebarStyles.logoutBtn} onClick={() => navigate("/")}>
          <span style={sidebarStyles.icon}>🏃</span>
          <span style={sidebarStyles.label}>Logout</span>
        </button>
      </div>
