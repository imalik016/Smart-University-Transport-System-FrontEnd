...
//       <div style={dashStyles.mainContent}>
...
//           <div style={dashStyles.statCard}><h3>Active Students</h3><p>1,240</p></div>
//           <div style={dashStyles.statCard}><h3>Buses on Route</h3><p>14</p></div>
//           <div style={dashStyles.statCard}><h3>Pending Alerts</h3><p>2</p></div>
//         </div>

//         <div style={dashStyles.welcomeInfo}>
//           <h2>Quick Start Guide</h2>
//           <ul>
//             <li>Use <b>Manage Users</b> to edit existing accounts.</li>
//             <li>Go to <b>Add New</b> to register Students, Faculty, or Drivers.</li>
//             <li>Monitor live transit in the <b>Live Map</b> section.</li>
//           </ul>
//         </div>
//       </div>
//     </div>
...
// const dashStyles = {
//   container: { display: "flex", minHeight: "100vh", backgroundColor: "#1A243A" },
//   mainContent: { flex: 1, marginLeft: "260px", padding: "40px", color: "#FFF" },
//   header: { marginBottom: "40px" },
//   statsGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "20px", marginBottom: "40px" },
//   statCard: { backgroundColor: "#0D1117", padding: "20px", borderRadius: "15px", border: "1px solid #2D3748", textAlign: "center" },
//   welcomeInfo: { backgroundColor: "#0D1117", padding: "30px", borderRadius: "15px", lineHeight: "1.8" }
// };
